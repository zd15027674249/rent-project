<template>
  <div class="mod-user">
    ...
    <project-count-art-in v-if="caseAnalysis" ref="caseProject"/>
  </div>
</template>

<script>
  import AddOrUpdate from './component/case-add-or-update'
  import ProjectCountArtIn from './component/project-count-art-in'
  ...
  export default {
    ...
    components: {
      AddOrUpdate, Case, ProjectCountArtIn
    },
    mounted () {
    ...
    methods: {
      ...
      initTable(){
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/criminal/case/item/list`),
            method: 'get',
      ...
      deleteHandle (id) {
        this.$confirm(`确定删除吗`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/sys/criminal/case/item/delete'),
            method: 'post',
      ...
      submitSave(){
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/criminal/case/item/save`),
            method: 'post',
            data: {
              caseName:caseName,
              caseTeam:caseTeam,
      ...
      submitSaveUpdate(){
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/criminal/case/item/update`),
            method: 'post',
            data: {
              id:id,
              caseName:caseName,
      ...
      exportTable(){
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/criminal/case/item/export`),
            method: 'get',
