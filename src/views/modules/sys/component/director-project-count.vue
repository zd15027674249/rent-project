  ...
  export default {
    ...
    methods: {
      ...
      getSelecxingshianjian(){
         this.$http({
            url: this.$http.adornUrl(`/sys/dict/get/xingzhenganjian`),
            method: 'get',
          }).then(({data}) => {
      ...
      initChartBar () {
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/administrative/case/report `),
            method: 'post',
