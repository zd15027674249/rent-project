  ...
  export default {
    ...
    methods: {
      ...
      getSelecxingshianjian(){
         this.$http({
            url: this.$http.adornUrl(`/sys/dict/get/xingshianjianitem`),
            method: 'get',
          }).then(({data}) => {
      ...
      initChartBar () {
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/criminal/case/item/report`),
            method: 'post',
