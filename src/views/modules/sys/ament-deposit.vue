  ...
  <div class="mod-user">
        ...
        <el-col :span="18">
          ...
          <el-form-item label="主办人">
           ...
           <el-form-item label="嫌疑人">
            <el-input clearable  v-model="dataFormSearch.xyrName" placeholder="输入案件名称"></el-input>
          </el-form-item>
          <el-col :span="20">
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="金额" label-width='100px' prop="jineForm">
            <el-input oninput="value=value.replace(/[^\d]/g,'')" maxlength='9' :disabled='disabled' v-model.number="dataForm.jineForm" placeholder="输入金额"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
       ...
       <el-row>
        <el-col :span="12">
          <el-form-item label="嫌疑人" label-width='100px' prop="xyr">
            <el-input :disabled='disabled' v-model="dataForm.xyr" placeholder="输入嫌疑人名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
           <el-form-item label="状态" prop="statusForm" label-width='100px'>
            <el-select :disabled='disabled' v-model="dataForm.statusForm" @change="statusFormChange" filterable placeholder="请选择">
              <el-option
    ...
    <project-count-ament-dep v-if="caseAnalysis" ref="caseProject"/>
  </div>
</template>

<script>
  import AddOrUpdate from './component/case-add-or-update'
  import ProjectCountAmentDep from './component/project-count-ament-dep'
  ...
  export default {
    ...
    components: {
      AddOrUpdate, Case, ProjectCountAmentDep
    },
    mounted () {
      // this.$refs.caseRef.list()
      this.getSelectamountstatus()
    ...
    methods: {
      ...
      initTable(){
        ...
        const {seachCase,seachZBRChangeCase,xyrName,addDate} = this.dataFormSearch
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/criminal/case/amount/list`),
            method: 'get',
      ...
      deleteHandle (id) {
        this.$confirm(`确定删除吗`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/sys/criminal/case/amount/delete'),
            method: 'post',
      ...
      submitSave(){
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/criminal/case/amount/save`),
            method: 'post',
            data: {
              caseName:caseName,
              caseTeam:caseTeam,
      ...
      submitSaveUpdate(){
        ...
        this.$http({
            url: this.$http.adornUrl(`/sys/criminal/case/amount/update`),
            method: 'post',
            data: {
              id:id,
              caseName:caseName,
      ...
      statusFormChange(value){
        this.dataForm.statusForm = value
      },
      // 新增 / 修改
      ...
      //状态
      getSelectamountstatus(){
         this.$http({
            url: this.$http.adornUrl(`/sys/dict/get/amountstatus`),
            method: 'get',
          }).then(({data}) => {
