  ...
  <aside class="site-sidebar" :class="'site-sidebar--' + sidebarLayoutSkin">
    <div class="site-sidebar__inner">
      <el-menu
        ...
        <el-menu-item index="lawsAndRegulations" @click="$router.push({ name: 'lawsAndRegulations' })">
          <icon-svg name="lawsAndRegulations" class="site-sidebar__menu-icon"></icon-svg>
